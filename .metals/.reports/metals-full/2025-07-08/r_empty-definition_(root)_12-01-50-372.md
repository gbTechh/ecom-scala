error id: file://<WORKSPACE>/src/main/scala/http/views/OrderView.scala:java/text/NumberFormat#
file://<WORKSPACE>/src/main/scala/http/views/OrderView.scala
empty definition using pc, found symbol in pc: java/text/NumberFormat#
semanticdb not found
empty definition using fallback
non-local guesses:
	 -scalatags/Text.all.NumberFormat.
	 -java/text/NumberFormat.
	 -NumberFormat.
	 -scala/Predef.NumberFormat.
offset: 266
uri: file://<WORKSPACE>/src/main/scala/http/views/OrderView.scala
text:
```scala
package http.views
...
object OrderView {
  private val currencyFormat = N@@umberFormat.getCurrencyInstance(Locale.US)
