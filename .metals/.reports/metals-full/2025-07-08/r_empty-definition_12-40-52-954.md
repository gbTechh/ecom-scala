error id: file://<WORKSPACE>/src/main/scala/http/views/CartView.scala:`<error>`#`<error>`.
file://<WORKSPACE>/src/main/scala/http/views/CartView.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -scalatags/Text.all.h4.
	 -scalatags/Text.all.h4#
	 -scalatags/Text.all.h4().
	 -h4.
	 -h4#
          ...
          div(
            table(
              ...
              tbody(
                cart.items.map { item =>
                  tr(
                    td(s"Product ID: ${item.productId}"), // Aquí deberías mostrar el nombre real
                    td(priceDisplay(item.unitPrice)),
                    td(item.quantity.toString),
                    td(priceDisplay(item.unitPrice * item.quantity)),
                    td(
