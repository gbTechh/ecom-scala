error id: file://<WORKSPACE>/src/main/scala/service/OrderService.scala:
file://<WORKSPACE>/src/main/scala/service/OrderService.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -cats/syntax/all/validateOrder.
	 -cats/syntax/all/validateOrder#
	 -cats/syntax/all/validateOrder().
	 -validateOrder.
	 -validateOrder#
	 -validateOrder().
	 -scala/Predef.validateOrder.
	 -scala/Predef.validateOrder#
	 -scala/Predef.validateOrder().
offset: 916
        ...
        case Some(order) =>
          (order.status, newStatus) match {
            ...
            case (_, OrderStatus.Pending) =>
              IO.raiseError(
                new IllegalStateException("Cannot revert to Pending status")
              )
